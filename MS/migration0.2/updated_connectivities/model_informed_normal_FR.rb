...
out_fn = "output_informed_normal_migration2_FR" #Modify each run if needed
geo_fn = "simulated"
...
out_str = "output_informed_normal_migration2_FR" #May need to modify depending on output filename
