...
<<<<<<< HEAD:MS/migration0/model_informed_uniform.rb
out_fn = "output_informed_uniform2" #Modify each run if needed
=======
out_fn = "output_informed_uniform1" #Modify each run if needed
>>>>>>> 93c73ef93240767487d2735d4806add882a1c1d9:migration0/scripts/model_informed_uniform.rb
geo_fn = "simulated"
...
<<<<<<< HEAD:MS/migration0/model_informed_uniform.rb
out_str = "output_informed_uniform2" #May need to modify depending on output filename
=======
