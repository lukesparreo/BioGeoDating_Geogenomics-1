# RevBayes code for geology informed (correct) model with normal distribution

range_fn = "simulated_range.nex"
mol_fn = "modified_sequences_filled.nex"
tree_fn = "collapsed_newick.tre"
<<<<<<< HEAD:MS/migration0/model_informed_normal.rb
out_fn = "output_informed_normal2" #Modify each run if needed
=======
out_fn = "output_informed_normal1" #Modify each run if needed
>>>>>>> 93c73ef93240767487d2735d4806add882a1c1d9:migration0/scripts/model_informed_normal.rb
geo_fn = "simulated"
...
<<<<<<< HEAD:MS/migration0/model_informed_normal.rb
out_str = "output_informed_normal2" #May need to modify depending on output filename
=======
