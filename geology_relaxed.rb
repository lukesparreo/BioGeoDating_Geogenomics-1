...
out_fn = "output_aware_uniform_strict_2/simulationoutput" #MODIFY EACH RUN!
geo_fn = "/Users/lukesparreo/simulated_data/simulated"
times_fn = geo_fn + ".times.awarestrict.txt" #MODIFY EACH RUN!
...
out_str = "output_aware_uniform_strict_2/simulationoutput" #MODIFY EACH RUN!
